...
export const HeroSection = () => {
  ...
  const jsonLd = [
  {
    ...
    "@type": "WebSite",
    "name": "Martin Knapp — Full-Stack Web Developer",
    "url": "https://www.yourdomain.com",
    "description": "Portfolio of Martin Knapp, a full-stack web developer specializing in workflow automation, custom web applications, and scalable systems for businesses and organizations.",
    "publisher": {
      "@type": "Person",
      "name": "Martin Knapp"
    }
...

  {
    ...
    "description": "Full-stack web developer building high-performance web applications that automate workflows for businesses, enterprises, and organizations.",
    "skills": [
      "React",
      "Vite",
      "Node.js",
    ...
    "sameAs": [
      "https://www.linkedin.com/in/mknapp360/", 
      "https://github.com/mknapp360",           
    ]
  },
  {
    "@context": "https://schema.org",
    "@type": "Service",
    "serviceType": "Custom web application development & workflow automation",
    "provider": {
      "@type": "Person",
      "name": "Martin Knapp",
      "url": "https://knapponthejob.com/"       
    ...
    "description": "Design and development of high-performance web applications, dashboards, and internal tools that automate workflows and business processes for startups, enterprises, and organizations.",
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Web development & workflow automation services",
      "itemListElement": [
        {
          "@type": "Offer",
          "name": "Custom workflow web applications",
          "description": "Bespoke applications that streamline operations and automate repetitive tasks."
        },
        {
          "@type": "Offer",
          "name": "Internal admin tools & dashboards",
          "description": "Data dashboards and control panels for teams, finance, and operations."
        },
        {
          "@type": "Offer",
          "name": "MVP design & development",
          "description": "End-to-end build of minimum viable products for startups and new ventures."
        }
      ]
    }
  },
  ...
  const codeSnippets = [
    "import { FullStackDeveloper } from 'knapponthejob.com';",
    "",
  ...
  const achievements = [
    { number: "9+", label: "Years in Production" },
    { number: "15+", label: "Programming languages used"},
  ...
  const handleViewResume = () => {
    ...
    window.open('/mknappCV.pdf', '_blank', 'noopener,noreferrer');
  };
          ...
          <motion.div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-20" initial="hidden" animate={isInView ? "visible" : "hidden"} variants={{ hidden: { opacity: 0 }, visible: { opacity: 1, transition: { staggerChildren: 0.25, delayChildren: 0.5 } } }}>
            ...
            <div className="flex-1 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
              ...
              <motion.h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight tracking-tight" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
                ...
                <span className="block text-foreground">Martin Knapp</span>
                <motion.span className="block bg-gradient-to-r from-primary via-green-600 to-white-600 bg-clip-text text-transparent mt-2" animate={{ backgroundPosition: ['0%', '100%', '0%'] }} transition={{ duration: 8, repeat: Infinity }} style={{ backgroundSize: '200% 100%' }}>
                  Full-Stack
                </motion.span>
                <motion.span className="block bg-gradient-to-r from-primary via-green-600 to-white-600 bg-clip-text text-transparent mt-2" animate={{ backgroundPosition: ['0%', '100%', '0%'] }} transition={{ duration: 8, repeat: Infinity }} style={{ backgroundSize: '200% 100%' }}>
                  Web Developer
              ...
              <motion.p className="text-lg sm:text-xl text-muted-foreground mt-6 leading-relaxed max-w-2xl" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
                I build <span className="text-green-600 font-semibold">web applications that automate workflows</span> for businesses, enterprise, and organizations.
              </motion.p>
              ...
              <motion.div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
                <motion.a href="#projects" className="group relative overflow-hidden px-8 py-4 rounded-xl font-semibold bg-gradient-to-r from-green-600 to-white text-primary-foreground shadow-lg hover:shadow-xl text-sm flex items-center justify-center gap-3" whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.95 }}>
              ...
              <motion.div className="mt-6 text-center lg:text-left" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
                <div className="text-sm text-muted-foreground">
                  <span className="text-green-600 font-semibold">Available </span> for Full-Stack and Frontend roles
                </div>
              </motion.div>
            </div>
